...
let multiplicationPar= parseInt(prompt("Je peux vous afficher les n premières tables de multiplication. " +
    "Dites-moi à laquelle vous souhaitez que je m'arrête. Par exemple, si vous entrez 4, " +
    "je vous afficherai les tables de multiplication par 1, par 2, par 3 et par 4. " +
    "Jusqu'à quelle table voulez-vous que j'aille ?"));

let combienDeValeurs = parseInt(prompt("Combien de valeurs souhaitez-vous que j'affiche " +
    "pour chacune de ces tables ?"));

console.log(`OK, je vais vous afficher les ${combienDeValeurs} premières valeurs des ${multiplicationPar} premières tables de multiplication.`);
